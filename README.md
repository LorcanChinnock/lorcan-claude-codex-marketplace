...
- [`creative-studio`](plugins/creative-studio) — creative design skills for ideation and direction. `creative-director` acts as a senior UX/creative director: live-researches current AI design tropes to avoid and fresh references each session, then produces opinionated, conceptually rich design direction — named concepts, a concrete recommendation, and a curated reference list. Never relies on baked-in research.
